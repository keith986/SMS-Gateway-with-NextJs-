...
export default function AddUsers () {
   ...
   await addDoc(collection(db, "clientusers"),{
                      username: userDetails.username.toLocaleString(),
                      phonenumber: userDetails.phonenumber.toLocaleString(),
                      location: userDetails.location.toLocaleString(),
                      roomno: userDetails.roomno.toLocaleString()
         })
         .then(() => {
...
<div className="p-4 sm:ml-64 mt-20">
   <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
      <div className="grid grid-cols-2 gap-4 mb-4">
         <a href="/users" className="cursor-pointer flex items-center justify-center h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
            <p className="flex items-center justify-center flex-col text-2xl text-gray-400 dark:text-gray-500">
               ...
               <p className="text-2xl text-white-400 dark:text-white">All user</p>
            </p>
         </a>
         <a href="/add-user" className="cursor-pointer flex items-center justify-center h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
            <p className="flex items-center justify-center flex-col text-2xl text-gray-400 dark:text-gray-500">
                ...
                <p className="text-2xl text-white-400 dark:text-white">Add user</p>
            </p>
         </a>
      </div>
...
<div className="w-full relative overflow-x-auto p-2 sm:rounded-lg">
  ...
  <div className="flex flex-col items-center justify-center px-1 py-1 mx-auto md:h-screen lg:py-0">
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
         <div className="p-1 space-y-6 md:space-y-12 sm:p-3">
               ...
               <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                  <div>
                     <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                      <Input type="text" name="username" id="username" onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Client's Username"  required=""/>
                  </div>
                  <div>
                      <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone number</label>
                      <Input type="text" name="phonenumber" id="phonenumber" onChange={handleChange} placeholder="Client's Phone Number" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""/>
                  </div>
                  <div>
                      <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Location</label>
                      <Input type="text" name="location" id="location" onChange={handleChange} placeholder="Client's Location" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""/>
                  </div>
                  <div>
                      <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Room Number</label>
                      <Input type="text" name="roomno" id="roomno" onChange={handleChange} placeholder="Client's Room No." className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""/>
                  </div>
                  <button type="submit" className="flex justify-center cursor-pointer w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                  <span>add client</span>
                  {isLoad === true ? <Loader2 className="animate-spin"/> : ''}
                  </button>
               </form>
         </div>
     </div>
