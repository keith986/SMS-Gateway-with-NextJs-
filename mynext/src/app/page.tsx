...
<div className="p-4 sm:ml-64 mt-20">
   <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
      <div className="grid grid-cols-3 gap-4 mb-4">
         ...
         <div className="flex items-center justify-center h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
            <p className="text-2xl text-gray-400 dark:text-gray-500">
               ...
               <span className="text-2xl text-white-400 dark:text-white">{allClients.length}</span>
            </p>  
         </div>
         <div className="flex items-center justify-center h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
            <p className="text-2xl text-gray-400 dark:text-gray-500">
      ...
      <div className="flex items-center justify-center h-45 mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
         <p className=" p-2 text-white-400 dark:text-white">
            OUR modern SMS system allows you to easily send text messages online with ease to as many users as you can. It provides a simple interface for composing messages, managing contacts, and viewing message history. The platform is ideal for businesses and individuals who want to communicate quickly and efficiently with their audience, offering features like bulk messaging, delivery reports, and secure data handling.
         </p>
      </div>
      <div className="flex items-center justify-center mb-4 rounded-sm ">
        <p className="text-2xl text-gray-400 dark:text-gray-700 p-2">
               What We Offer
        </p>
      </div>
